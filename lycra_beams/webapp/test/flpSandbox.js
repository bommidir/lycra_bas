		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comlycrabeams-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlycrabeams-display": {
								"semanticObject": "comlycrabeams",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lycrabeams",
									"url": sap.ui.require.toUrl("com/lycrabeams")
								}
							}
						}
					}
